...
$body = [
    'title' => __('Recharge Bakong Wallet Cambodia'),
    'desc'   => 'CMSNT Panel',
...
if (isset($_POST['SaveSettings'])) {
    ...
    $CMSNT->insert("logs", [
        ...
        'device'        => getUserAgent(),
        'createdate'    => gettime(),
        'action'        => __('Cấu hình nạp tiền Bakong Wallet Cambodia')
    ]);
    ...
    $my_text = str_replace('{action}', __('Cấu hình nạp tiền Bakong Wallet Cambodia'), $my_text);
...
$urlDatatable = pagination(base_url_admin("recharge-bakong&limit=$limit&shortByDate=$shortByDate&created_at=$createdate&trans_id=$trans_id&amount=$amount&user_id=$user_id&username=$username&status=$status&"), $from, $totalDatatable, $limit);
...
$total_yesterday = intval($CMSNT->get_row("SELECT SUM(price) FROM payment_bakong WHERE `status` = 1 AND  `created_at` LIKE '%".$yesterday."%' ")['SUM(price)']);
$total_today = $CMSNT->get_row("SELECT SUM(price) FROM payment_bakong WHERE `status` = 1 AND `created_at` LIKE '%".$currentDate."%' ")['SUM(price)'];
$total_all_time = $CMSNT->get_row("SELECT SUM(price) FROM payment_bakong WHERE `status` = 1 ")['SUM(price)'];


$checkKey = checkAddonLicense($CMSNT->site('bakong_license'), 'SHOPCLONE7_GATEWAY_bakong');
...
<div class="main-content app-content">
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0">Phương thức thanh toán Bakong Wallet Cambodia</h1>
        </div>
        <div class="row">
            <div class="col-xl-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-xl-12">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-5">
                                            <select class="form-control" name="bakong_status">
                                                <option <?=$CMSNT->site('bakong_status') == 1 ? 'selected' : '';?>
                                                    value="1">ON
                                                </option>
                                                <option <?=$CMSNT->site('bakong_status') == 0 ? 'selected' : '';?>
                                                    value="0">
                                                    OFF
                                                </option>
                                            </select>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control"
                                                ...
                                                value="<?=$CMSNT->site('bakong_license');?>" name="bakong_license">
                                        </div>
                                        <div
                                            ...
                                            <strong>Chú ý:</strong> Bạn cần phải mua giấy phép kích hoạt <a
                                                ...
                                                href="https://client.cmsnt.co/cart.php?a=add&pid=82">Addon</a> trước
                                            khi sử dụng. Truy cập Admin/Cài Đặt/Addons để mua giấy phép hoặc nhấn vào <a
                                                target="_blank" style="color: #007bff;"
                                                href="https://client.cmsnt.co/cart.php?a=add&pid=82">đây</a>.
                                        </div>
                                    </div>
                                </div>
                                <?php else:?>
                                <div class="col-lg-12 col-xl-6">
                                    ...
                                    <div class="row mb-4">
                                        <label class="col-sm-4 col-form-label" for="bakong_profile_id">Profile ID</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="bakong_profile_id"
                                                value="<?=$CMSNT->site('bakong_profile_id');?>"
                                                name="bakong_profile_id">
                                            <small>Thông tin Profile ID có thể tìm thấy tại <a href="https://raksmeypay.com/configuration" class="text-primary" target="_blank">đây</a></small>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label class="col-sm-4 col-form-label" for="bakong_profile_key">Profile Key</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="bakong_profile_key"
                                                value="<?=$CMSNT->site('bakong_profile_key');?>"
                                                name="bakong_profile_key">
                                            <small>Thông tin Profile Key có thể tìm thấy tại <a href="https://raksmeypay.com/configuration" class="text-primary" target="_blank">đây</a></small>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-5">
                                            <div class="input-group">
                                                <input type="text" class="form-control"
                                                    value="<?=$CMSNT->site('bakong_rate');?>" name="bakong_rate"
                                                    placeholder="">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control"
                                                value="<?=$CMSNT->site('bakong_min');?>" name="bakong_min">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control"
                                                value="<?=$CMSNT->site('bakong_max');?>" name="bakong_max">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label class="col-sm-4 col-form-label" for="example-hf-email">Proxy (nếu có)</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control"
                                                value="<?=$CMSNT->site('bakong_proxy');?>" name="bakong_proxy">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-xl-12">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea id="bakong_notice"
                                                name="bakong_notice"><?=$CMSNT->site('bakong_notice');?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <?php endif?>
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-fill">
                                        <p class="mb-1 fs-5 fw-semibold text-default">
                                            <?=format_currency($CMSNT->get_row("SELECT SUM(price) FROM payment_bakong WHERE `status` = 1 AND MONTH(created_at) = '$currentMonth' AND YEAR(created_at) = '$currentYear' ")['SUM(price)']);?>
                                        </p>
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-fill">
                                        <p class="mb-1 fs-5 fw-semibold text-default">
                                            <?=format_currency($CMSNT->get_row("SELECT SUM(price) FROM payment_bakong WHERE `status` = 1 AND YEAR(created_at) = $currentYear AND WEEK(created_at, 1) = $currentWeek ")['SUM(price)']);?>
                                        </p>
      ...
      echo '<span class="fs-12 text-danger ms-2"><i class="ti ti-trending-down me-1 d-inline-block"></i>' . round(abs($revenueGrowth), 2) . '% </span>';
            ...
            <div class="col-xl-7">
              ...
              ?>
                  ...
                  for ($day = 1; $day <= $numOfDays; $day++) {
                      $date = "$year-$month-$day";
                      $row = $CMSNT->get_row("SELECT SUM(price) FROM payment_bakong WHERE `status` = 1 AND DATE(created_at) = '$date' ");
                            ...
                            <div class="row row-cols-lg-auto g-3 mb-3">
                                ...
                                <div class="col-md-3 col-6">
                                    <select name="status" class="form-control form-control-sm">
                                        ...
                                        <option <?=$status == 3 ? 'selected' : '';?> value="3">Expired
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <a class="btn btn-sm btn-danger" href="<?=base_url_admin('recharge-bakong');?>"><i
                                            class="fa fa-trash"></i>
                                        <?=__('Clear filter');?>
                                    </a>
                                </div>
                            ...
                            <table class="table text-nowrap table-striped table-hover table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><b style="color:blue;">$<?=format_cash($row['amount']);?></b></td>
                                    ...
                                    <tr>
                                        <td colspan="7">
                                            <div class="float-right">
                                                <?=__('Paid:');?>
                                                <strong
                                                    style="color:red;"><?=format_currency($CMSNT->get_row(" SELECT SUM(`price`) FROM `payment_bakong` WHERE $where AND `status` = 1 ")['SUM(`price`)']);?></strong>
...
<script>
CKEDITOR.replace("bakong_notice");
</script>
