...
$body = [
    'title' => __('Recharge OpenPix Brazil'),
    'desc'   => 'CMSNT Panel',
...
if (isset($_POST['SaveSettings'])) {
    ...
    $CMSNT->insert("logs", [
        ...
        'device'        => getUserAgent(),
        'createdate'    => gettime(),
        'action'        => __('Cấu hình nạp tiền OpenPix Brazil')
    ]);
...
$total_yesterday = intval($CMSNT->get_row("SELECT SUM(price) FROM payment_openpix WHERE `status` = 1 AND  `created_at` LIKE '%".$yesterday."%' ")['SUM(price)']);
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-5">
                                            <select class="form-control" name="openpix_status">
                                                <option <?=$CMSNT->site('openpix_status') == 1 ? 'selected' : '';?>
                                                    value="1">ON
                                                </option>
                                                <option <?=$CMSNT->site('openpix_status') == 0 ? 'selected' : '';?>
                                                    value="0">
                                                    OFF
                                                </option>
                                            </select>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control"
                                                ...
                                                value="<?=$CMSNT->site('openpix_license');?>" name="openpix_license">
                                        </div>
                                        <div
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="openpix_api_key"
                                                value="<?=$CMSNT->site('openpix_api_key');?>"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="openpix_HMAC_key"
                                                value="<?=$CMSNT->site('openpix_HMAC_key');?>"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="openpix_HMAC_key_completed"
                                                value="<?=$CMSNT->site('openpix_HMAC_key_completed');?>"
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="openpix_webhook"
                                                    value="<?=base_url('api/webhook_openpix');?>" readonly>
                                ...
                                <div class="col-lg-12 col-xl-6">
                                    <div class="row mb-4">
                                        <label class="col-sm-7 col-form-label"
                                            for="example-hf-email"><?=__('1 R$ =');?></label>
                                        <div class="col-sm-5">
                                            <div class="input-group">
                                                <input type="text" class="form-control"
                                                    value="<?=$CMSNT->site('openpix_rate');?>" name="openpix_rate"
                                                    placeholder="">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control"
                                                value="<?=$CMSNT->site('openpix_min');?>" name="openpix_min">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control"
                                                value="<?=$CMSNT->site('openpix_max');?>" name="openpix_max">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-xl-12">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea id="openpix_notice"
                                                name="openpix_notice"><?=$CMSNT->site('openpix_notice');?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <?php endif?>
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-fill">
                                        <p class="mb-1 fs-5 fw-semibold text-default">
                                            <?=format_currency($CMSNT->get_row("SELECT SUM(price) FROM payment_openpix WHERE `status` = 1 AND MONTH(created_at) = '$currentMonth' AND YEAR(created_at) = '$currentYear' ")['SUM(price)']);?>
                                        </p>
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-fill">
                                        <p class="mb-1 fs-5 fw-semibold text-default">
                                            <?=format_currency($CMSNT->get_row("SELECT SUM(price) FROM payment_openpix WHERE `status` = 1 AND YEAR(created_at) = $currentYear AND WEEK(created_at, 1) = $currentWeek ")['SUM(price)']);?>
                                        </p>
                        ...
                        <form action="" class="align-items-center mb-3" name="formSearch" method="GET">
                            <div class="row row-cols-lg-auto g-3 mb-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <a class="btn btn-sm btn-danger" href="<?=base_url_admin('recharge-openpix');?>"><i
                                            class="fa fa-trash"></i>
                                        <?=__('Clear filter');?>
                                    </a>
                                </div>
                            ...
                            <table class="table text-nowrap table-striped table-hover table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><b style="color:blue;">R$ <?=format_cash($row['amount']);?></b></td>
                                    ...
                                    <tr>
                                        <td colspan="7">
                                            <div class="float-right">
                                                <?=__('Paid:');?>
                                                <strong
                                                    style="color:red;"><?=format_currency($CMSNT->get_row(" SELECT SUM(`price`) FROM `payment_openpix` WHERE $where AND `status` = 1 ")['SUM(`price`)']);?></strong>
