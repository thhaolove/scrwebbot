...
if (isset($_POST['SaveSettings'])) {
    ...
    $CMSNT->insert("logs", [
        ...
        'device'        => getUserAgent(),
        'createdate'    => gettime(),
        'action'        => __('Cấu hình nạp tiền PocketFi')
    ]);
    ...
    $my_text = str_replace('{action}', __('Cấu hình nạp tiền PocketFi'), $my_text);
...
$listDatatable = $CMSNT->get_list(" SELECT * FROM `payment_pocketfi` WHERE $where ORDER BY `id` DESC LIMIT $from,$limit ");
$totalDatatable = $CMSNT->num_rows(" SELECT * FROM `payment_pocketfi` WHERE $where ORDER BY id DESC ");
$urlDatatable = pagination(base_url_admin("recharge-pocketfi&limit=$limit&shortByDate=$shortByDate&created_at=$createdate&trans_id=$trans_id&amount=$amount&user_id=$user_id&username=$username&status=$status&"), $from, $totalDatatable, $limit);
...
$total_yesterday = intval($CMSNT->get_row("SELECT SUM(price) FROM payment_pocketfi WHERE `status` = 1 AND  `created_at` LIKE '%".$yesterday."%' ")['SUM(price)']);
$total_today = $CMSNT->get_row("SELECT SUM(price) FROM payment_pocketfi WHERE `status` = 1 AND `created_at` LIKE '%".$currentDate."%' ")['SUM(price)'];
$total_all_time = $CMSNT->get_row("SELECT SUM(price) FROM payment_pocketfi WHERE `status` = 1 ")['SUM(price)'];


$checkKey = checkAddonLicense($CMSNT->site('pocketfi_license'), 'SHOPCLONE7_GATEWAY_POCKETFI');
...
<div class="main-content app-content">
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0">Phương thức thanh toán PocketFi</h1>
        </div>
        <div class="row">
            <div class="col-xl-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-xl-12">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-5">
                                            <select class="form-control" name="pocketfi_status">
                                                <option <?=$CMSNT->site('pocketfi_status') == 1 ? 'selected' : '';?>
                                                    value="1">ON
                                                </option>
                                                <option <?=$CMSNT->site('pocketfi_status') == 0 ? 'selected' : '';?>
                                                    value="0">
                                                    OFF
                                                </option>
                                            </select>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control"
                                                ...
                                                value="<?=$CMSNT->site('pocketfi_license');?>" name="pocketfi_license">
                                        </div>
                                        <div
                                            ...
                                            <strong>Chú ý:</strong> Bạn cần phải mua giấy phép kích hoạt <a
                                                ...
                                                href="https://client.cmsnt.co/cart.php?a=add&pid=96">Addon</a> trước
                                            khi sử dụng. Truy cập Admin/Cài Đặt/Addons để mua giấy phép hoặc nhấn vào <a
                                                target="_blank" style="color: #007bff;"
                                                href="https://client.cmsnt.co/cart.php?a=add&pid=96">đây</a>.
                                        </div>
                                    </div>
                                </div>
                                <?php else:?>
                                <div class="col-lg-12 col-xl-6">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control"
                                                value="<?=$CMSNT->site('pocketfi_currency_code');?>"
                                                name="pocketfi_currency_code">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label class="col-sm-7 col-form-label"
                                            for="example-hf-email"><?=__('1 '.$CMSNT->site('pocketfi_currency_code').' =');?></label>
                                        <div class="col-sm-5">
                                            <div class="input-group">
                                                <input type="text" class="form-control"
                                                    value="<?=$CMSNT->site('pocketfi_rate');?>" name="pocketfi_rate"
                                                    placeholder="">
                                ...
                                <div class="col-lg-12 col-xl-6">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control"
                                                value="<?=$CMSNT->site('pocketfi_business_id');?>"
                                                name="pocketfi_business_id">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label class="col-sm-4 col-form-label" for="example-hf-email">API Token</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control"
                                                value="<?=$CMSNT->site('pocketfi_api_token');?>" name="pocketfi_api_token">
                                            <small>Bearer Token từ PocketFi</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-xl-6">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control"
                                                value="<?=$CMSNT->site('pocketfi_min');?>" name="pocketfi_min">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control"
                                                value="<?=$CMSNT->site('pocketfi_max');?>" name="pocketfi_max">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-xl-12">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea id="pocketfi_notice"
                                                name="pocketfi_notice"><?=$CMSNT->site('pocketfi_notice');?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <?php endif?>
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-fill">
                                        <p class="mb-1 fs-5 fw-semibold text-default">
                                            <?=format_currency($CMSNT->get_row("SELECT SUM(price) FROM payment_pocketfi WHERE `status` = 1 AND MONTH(created_at) = '$currentMonth' AND YEAR(created_at) = '$currentYear' ")['SUM(price)']);?>
                                        </p>
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-fill">
                                        <p class="mb-1 fs-5 fw-semibold text-default">
                                            <?=format_currency($CMSNT->get_row("SELECT SUM(price) FROM payment_pocketfi WHERE `status` = 1 AND YEAR(created_at) = $currentYear AND WEEK(created_at, 1) = $currentWeek ")['SUM(price)']);?>
                                        </p>
      ...
      echo '<span class="fs-12 text-danger ms-2"><i class="ti ti-trending-down me-1 d-inline-block"></i>' . round(abs($revenueGrowth), 2) . '% </span>';
            ...
            <div class="col-xl-7">
              ...
              ?>
                  ...
                  for ($day = 1; $day <= $numOfDays; $day++) {
                      $date = "$year-$month-$day";
                      $row = $CMSNT->get_row("SELECT SUM(price) FROM payment_pocketfi WHERE `status` = 1 AND DATE(created_at) = '$date' ");
                    ...
                    <div class="card-body">
                        <form action="" class="align-items-center mb-3" name="formSearch" method="GET">
                            <div class="row row-cols-lg-auto g-3 mb-3">
                                ...
                                <input type="hidden" name="action" value="recharge-pocketfi">
                                ...
                                <div class="col-12">
                                    ...
                                    <a class="btn btn-sm btn-danger" href="<?=base_url_admin('recharge-pocketfi');?>"><i
                                            class="fa fa-trash"></i>
                                        <?=__('Clear filter');?>
                                    </a>
                                </div>
                            ...
                            <table class="table text-nowrap table-striped table-hover table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><b><?=format_cash($row['amount']);?></b> <?=$CMSNT->site('pocketfi_currency_code');?></td>
                                    ...
                                    <tr>
                                        <td colspan="8">
                                            <div class="float-right">
                                                <?=__('Paid:');?>
                                                <strong
                                                    style="color:red;"><?=format_currency($CMSNT->get_row(" SELECT SUM(`price`) FROM `payment_pocketfi` WHERE $where AND `status` = 1 ")['SUM(`price`)']);?></strong>
...
<script>
CKEDITOR.replace("pocketfi_notice");
</script>
