...
$checkKey = checkAddonLicense($CMSNT->site('tmweasyapi_license'), 'SHOPCLONE7_GATEWAY_tmweasyapi');
...
<div class="main-content app-content">
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0">Phương thức thanh toán Tmweasyapi Thailand</h1>
        </div>
        <div class="row">
            <div class="col-xl-12">
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div
                                            ...
                                            <strong>Chú ý:</strong> Bạn cần phải mua giấy phép kích hoạt <a
                                                ...
                                                href="https://client.cmsnt.co/cart.php?a=add&pid=80">Addon</a> trước
                                            khi sử dụng. Truy cập Admin/Cài Đặt/Addons để mua giấy phép hoặc nhấn vào <a
                                                target="_blank" style="color: #007bff;"
                                                href="https://client.cmsnt.co/cart.php?a=add&pid=80">đây</a>.
                                        </div>
                                    </div>
                                </div>
                                <?php else:?>
                                ...
                                <!-- Watermark settings (áp dụng cho cả 2 trạng thái giấy phép) -->
                                <div class="col-lg-12 col-xl-12">
                                    <div class="card border-0 shadow-sm mb-3">
                                        <div class="card-header"><strong>Cấu hình Watermark QR</strong></div>
                                        <div class="card-body">
                                            <div class="row mb-3">
                                                <label class="col-sm-4 col-form-label" for="tmweasyapi_watermark_text">Watermark Text</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="tmweasyapi_watermark_text"
                                                        value="<?=$CMSNT->site('tmweasyapi_watermark_text');?>"
                                                        name="tmweasyapi_watermark_text" placeholder="<?=$CMSNT->site('title');?>">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label class="col-sm-4 col-form-label" for="tmweasyapi_watermark_color">Màu chữ (Hex)</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="tmweasyapi_watermark_color"
                                                        value="<?=$CMSNT->site('tmweasyapi_watermark_color');?>"
                                                        name="tmweasyapi_watermark_color" placeholder="#ff0000">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label class="col-sm-4 col-form-label" for="tmweasyapi_watermark_opacity">Độ mờ (0-1)</label>
                                                <div class="col-sm-8">
                                                    <input type="number" step="0.01" min="0" max="1" class="form-control" id="tmweasyapi_watermark_opacity"
                                                        value="<?=$CMSNT->site('tmweasyapi_watermark_opacity');?>"
                                                        name="tmweasyapi_watermark_opacity" placeholder="0.28">
                                                </div>
                                            </div>
                                            <div class="row mb-0">
                                                <label class="col-sm-4 col-form-label" for="tmweasyapi_watermark_font_size">Tỉ lệ kích thước (0.01-0.5)</label>
                                                <div class="col-sm-8">
                                                    <input type="number" step="0.01" min="0.01" max="0.5" class="form-control" id="tmweasyapi_watermark_font_size"
                                                        value="<?=$CMSNT->site('tmweasyapi_watermark_font_size');?>"
                                                        name="tmweasyapi_watermark_font_size" placeholder="0.08">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
