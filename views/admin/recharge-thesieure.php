...
<div class="main-content app-content">
    <div class="container-fluid">
        ...
        <div class="alert alert-danger alert-dismissible fade show custom-alert-icon shadow-sm" role="alert">
            ...
            Vui lòng thực hiện <b><a target="_blank" class="text-primary" href="https://help.cmsnt.co/huong-dan/huong-dan-xu-ly-khi-website-bao-loi-cron/">CRON JOB</a></b> liên kết: <a class="text-primary" href="<?=base_url('cron/thesieure.php?key='.$CMSNT->site('key_cron_job'));?>"
                target="_blank"><?=base_url('cron/thesieure.php?key='.$CMSNT->site('key_cron_job'));?></a> 1 phút 1 lần để hệ thống xử lý nạp tiền tự động.
