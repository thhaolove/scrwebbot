...
<section class="py-5 inner-section profile-part">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="home-heading mb-3">
                    <h3><i class="fa-solid fa-university m-2"></i> <?=mb_strtoupper(__('Thông tin chuyển khoản'));?>
                    </h3>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mb-4">
                        <div class="account-card h-100">
                            <div class="text-center py-3">
                                ...
                                <img src="https://api.web2m.com/api/qrmomo.php?amount=0&phone=<?=$bank['accountNumber'];?>&noidung=<?=urlencode($CMSNT->site('prefix_autobank')).$getUser['id'];?>&size=300" width="100%" style="max-width:300px;display:block;margin:0 auto;" onerror="this.style.display='none'; document.getElementById('default-<?=$bank['id'];?>').style.display='block';"/>
                                <?php else:?>
                                <?php
                                ...
                                $img = $img1;
                                ?>
                                <img src="<?=$img;?>" width="100%" style="max-width:300px;display:block;margin:0 auto;" id="vietqr-<?=$bank['id'];?>" onerror="this.style.display='none'; document.getElementById('default-<?=$bank['id'];?>').style.display='block';"/>
                                <img class="mb-3" src="<?=base_url($bank['image']);?>" width="100%" style="max-width:300px;display:none;margin:0 auto;" id="default-<?=$bank['id'];?>">
                                <?php endif?>
                            </div>
                            <ul class="list-group">
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span><?=__('Số tài khoản:');?></span>
                                        <div>
                                            <b id="copySTK<?=$bank['id'];?>" style="color: green;"><?=$bank['accountNumber'];?></b>
                                            <button onclick="copy()" class="copy btn btn-sm btn-primary ms-2" data-clipboard-target="#copySTK<?=$bank['id'];?>">
                                ...
                                <li class="list-group-item" style="font-size:17px;">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span><?=__('Nội dung CK:');?></span>
                                        <div>
                                            <b id="copyNoiDung<?=$bank['id'];?>" style="color: red;"><?=$CMSNT->site('prefix_autobank').$getUser['id'];?></b>
                                            <button onclick="copy()" class="copy btn btn-sm btn-danger ms-2" data-clipboard-target="#copyNoiDung<?=$bank['id'];?>">
                                                <i class="fas fa-copy"></i>
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span><?=__('Chủ tài khoản:');?></span>
                                        <b><?=$bank['accountName'];?></b>
                                    </div>
                                </li>
                            </ul>
                            <div class="text-center mt-3">
                                <small class="text-muted"><?=__('Nhập đúng nội dung chuyển khoản để hệ thống cộng tiền tự động...');?></small>
                            </div>
                        </div>
                    </div>
                    <?php endforeach?>
