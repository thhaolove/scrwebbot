...
$sql_list = "SELECT * FROM `users` WHERE $where_clause ORDER BY `id` DESC LIMIT ?, ?";
...
<section class="py-5 inner-section profile-part">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="account-card">
                    ...
                    <div class="wallet-card-group">
                        ...
                        <div class="wallet-card">
                            <p><?=__('Thành viên đã giới thiệu');?></p>
                            <h3><?=format_cash($CMSNT->get_row_safe("SELECT COUNT(id) as total FROM `users` WHERE `ref_id` = ?", [$getUser['id']])['total']);?>
                            </h3>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6">
                <div class="account-card">
                    <h4 class="account-title"><?=__('Liên kết giới thiệu của bạn');?></h4>
                    <form class="wallet-form">
                        <input type="text" class="mb-3" readonly id="urlRef"
                            value="<?=base_url('?aff='.$getUser['id']);?>">
                        <center>
                            <ul class="footer-social">
                                <li><a target="_blank"
                                        href="https://www.facebook.com/sharer/sharer.php?u=<?=base_url('join/'.$getUser['id']);?>"><i class="fa-brands fa-facebook"></i></a>
                                </li>
                                <li><a target="_blank"
                                        href="https://twitter.com/intent/tweet?url=<?=base_url('join/'.$getUser['id']);?>"><i class="fa-brands fa-square-x-twitter"></i></a>
                                </li>
                                <li><a target="_blank"
                                        href="https://www.linkedin.com/sharing/share-offsite/?url=<?=base_url('join/'.$getUser['id']);?>"><i class="fa-brands fa-linkedin"></i></a>
                                </li>
                                <li><a target="_blank"
                                        href="https://www.instagram.com/?url=<?=base_url('join/'.$getUser['id']);?>"><i class="fa-brands fa-instagram"></i></a>
                                </li>
                            </ul>
                            <button type="button" onclick="copy()" class="copy"
                                data-clipboard-target="#urlRef"><?=__('Copy');?></button>
                        </center>
            ...
            <div class="col-md-12">
                <div class="account-card">
                    <h4 class="account-title"><?=__('Thông tin chi tiết khách hàng');?></h4>
                    <form action="" method="GET">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg col-md-4 col-6">
                                <a href="<?=base_url('?action=affiliates');?>" class="shop-widget-btn mb-2"><i
                        ...
                        <table class="table fs-sm mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><b style="color: green;"><?=format_cash($row2['ref_amount']);?></b></td>
                                </tr>
                                <?php }?>
                            </tbody>
                        </table>
