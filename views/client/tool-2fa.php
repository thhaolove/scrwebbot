...
$body = [
    'title' => __('Công cụ lấy mã 2FA Google Authenticator').' | '.$CMSNT->site('title'),
        ...
        <div class="row">
            <div class="col-12">
                <div class="posterd home mb-3" style="background-image: url(<?=base_url('mod/img/bg-intro.webp');?>)">
                    <div class="welcomto">
                        <div class="box-intro">
                            <img src="<?=base_url('mod/img/icon-google-auth.webp');?>" alt="Accnice" width="70" height="70">
                        </div>
                        <div class="">
                            <div
                            ...
                            <h1
                                ...
                                <?=__('Tool Get 2FA Google Authenticator');?></h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="account-card pt-3">
                    <iframe src="https://2fa.zone/" class="border border-dark" width="100%"
