                    ...
                    <div>
                        ...
                        <div class="theme-colors">
                            ...
                            <div class="d-flex flex-wrap align-items-center switcher-style">
                                ...
                                <div class="form-check switch-select me-3">
                                    <input class="form-check-input color-input color-bg-bg-3" type="radio"
            ...
            <div class="main-header-container container-fluid">
                ...
                <div class="header-content-left">
                    ...
                    <div class="header-element">
                        <div class="horizontal-logo">
                            <a href="<?=base_url_ctv();?>" class="header-logo">
                                <img src="<?=base_url($CMSNT->site('logo_light'));?>" alt="logo" class="desktop-logo">
                                <img src="<?=base_url($CMSNT->site('favicon'));?>" alt="logo" class="toggle-logo">
                                <img src="<?=base_url($CMSNT->site('logo_dark'));?>" alt="logo" class="desktop-dark">
                                <img src="<?=base_url($CMSNT->site('favicon'));?>" alt="logo" class="toggle-dark">
                                <img src="<?=base_url($CMSNT->site('logo_light'));?>" alt="logo" class="desktop-white">
                                <img src="<?=base_url($CMSNT->site('favicon'));?>" alt="logo" class="toggle-white">
                            </a>
                        </div>
                    </div>
                    <!-- End::header-element -->
                ...
                <div class="header-content-right">
                    <div class="header-element header-search">
                        <!-- Start::header-link -->
                        <a href="<?=base_url();?>" class="header-link" title="Về trang chủ">
                    ...
                    <div class="header-element">
                        <!-- Start::header-link -->
                        <a href="<?=base_url('client/logout');?>" class="header-link" title="Đăng xuất">
                            <i class="bx bx-log-out header-link-icon"></i>
                        </a>
                        <!-- End::header-link -->
                    </div>
                    <!-- End::header-element -->
        ...
        <aside class="app-sidebar sticky" id="sidebar">
            ...
            <div class="main-sidebar" id="sidebar-scroll">
                ...
                <nav class="main-menu-container nav nav-pills flex-column sub-open">
                    ...
                    <ul class="main-menu">
                        <li class="slide__category"><span class="category-name">CTV Panel</span></li>
                        <li class="slide">
                            <a href="<?=base_url_ctv('home');?>"
                        ...
                        <li class="slide__category"><span class="category-name">Quản lý bán hàng</span></li>
                        
                        <li class="slide">
                            <a href="<?=base_url_ctv('product-orders');?>"
                                class="side-menu__item <?=active_sidebar(['product-orders']);?>">
                                <i class="bx bx-cart side-menu__icon"></i>
                                <span class="side-menu__label">Đơn hàng của tôi</span>
                            </a>
                        </li>
                        
                        <li class="slide">
                            <a href="<?=base_url_ctv('products');?>"
                                class="side-menu__item <?=active_sidebar(['products', 'product-add', 'product-edit', 'product-stock']);?>">
                        ...
                        <li class="slide">
                            <a href="<?=base_url_ctv('ctv-withdraw');?>"
                                class="side-menu__item <?=active_sidebar(['ctv-withdraw']);?>">
                                <i class="bx bx-credit-card side-menu__icon"></i>
                                <span class="side-menu__label">Rút tiền</span>
                            </a>
                        </li> 
