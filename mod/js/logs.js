    ...
    var LogsTable = {
        ...
        init: function() {
            ...
            this.elements = {
                ...
                loadingSkeleton: document.getElementById('logsLoading'),
                emptyState: document.getElementById('logsEmpty'),
                loadMoreWrapper: document.getElementById('loadMoreWrapper'),
                btnLoadMore: document.getElementById('btnLoadMore'),
                filterForm: document.getElementById('logsFilterForm'),
            ...
            if (this.elements.filterIp) this.state.ip = this.elements.filterIp.value || '';
        ...
        bindEvents: function() {
            ...
            if (this.elements.filterForm) {
                this.elements.filterForm.addEventListener('submit', function(e) {
                    ...
                    self.state.ip = self.elements.filterIp ? self.elements.filterIp.value : '';
            ...
            if (this.elements.resetFilter) {
                this.elements.resetFilter.addEventListener('click', function(e) {
                    ...
                    if (self.elements.filterIp) self.elements.filterIp.value = '';
